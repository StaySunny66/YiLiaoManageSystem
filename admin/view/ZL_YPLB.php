        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">药品列表</h1>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">药品列表</h6>
                            </div>
                                        ...
                                        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                            <div class="row"><div class="col-sm-12 col-md-6">
                                                    <div class="dataTables_length" id="dataTable_length">
                                                        ...
                                                        <thead>
                                                        <tr role="row">
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="药品编号: activate to sort column ascending" style="width: 69px;">药品编号</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="药品名称: activate to sort column ascending" style="width: 59px;">药品名称</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="库存余量: activate to sort column ascending" style="width: 59px;">库存余量</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <?php
                                                        ...
                                                        foreach ($data as $data_line){
                                                            ...
                                                            echo "<tr class=\"odd\">
                                                                                <td class=\"sorting_1\">$L1</td><td>$L2</td><td>$L3</td>
                                                                       </tr>";
