...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">医生<sup>后台</sup></div>
        </a>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="/doctor/?view=main">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">数据查看</h6>
                    <a class="collapse-item" href="/doctor/?view=WDHZ">我的患者</a>
                    <a class="collapse-item" href="/doctor/?view=WDYY">我的预约</a>
                </div>
            </div>
        </li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">我的患者</h1>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">患者信息操作</h6>
                        </div>
                                    ...
                                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                        <div class="row"><div class="col-sm-12 col-md-6">
                                                <div class="dataTables_length" id="dataTable_length">
                                                    ...
                                                    <thead>
                                                    <tr role="row">
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="编号: activate to sort column ascending" style="width: 69px;">编号</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="姓名: activate to sort column ascending" style="width: 59px;">姓名</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="性别: activate to sort column ascending" style="width: 59px;">性别</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="职位: activate to sort column ascending" style="width: 134px;">手机号</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="部门: activate to sort column ascending" style="width: 148px;">家庭住址</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="部门: activate to sort column ascending" style="width: 148px;">基础病</th>
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $data = get_my_user_list($hander['juese']);
                                                    //var_dump($data);
                                                    foreach ($data as $data_line){
                                                       ...
                                                       // var_dump($data_line);
                                                        ...
                                                        echo "<tr class=\"odd\">
                                                                                <td class=\"sorting_1\">$L1</td><td>$L2</td><td>$L3</td><td>$L4</td><td>$L5</td><td>$L6</td> <td> <a  href=\"./?view=KY&hz_id=$L1\" class=\"btn btn-primary\" >开药 </a>   </td>
                                                               </tr>";
