...
$hz_data = get_user_message($_GET["hz_id"]);
var_dump($hz_data);
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">开药</h6>
                        </div>
                        <div class="card-body " style="padding-top: 30px;padding-left: 10px">
                            <!-- Circle Buttons (Default) -->
                            <div class="p-1 ">
                                <p>患者姓名: <?php echo $hz_data['hz_name']?></p>
                                <p>性别: <?php echo $hz_data['hz_sex']?></p>
                                <p>基础病: <?php echo $hz_data['hz_jcb']?></p>

                                <div  style="width: 100%; display: block;">
                                    <form action="./yp_add.php?hz_id=<?php echo $hz_data['hz_id']?>" method="post">
                                        ...
                                        <div>
                                            <button id="renow" type="submit"  class=" mt-2 btn btn-primary">
                                                <span class="text" id="renow">开药</span>
                                            </button>
