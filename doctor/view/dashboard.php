                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            主治患者 (名)</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo get_zz_hz_num($hander['juese'])?></div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">创建预约门诊</h6>
                            </div>
                            <div class="card-body " style="padding-top: 30px;padding-left: 10px">
                                <div class="p-1 ">
                                    <div  style="width: 100%; display: block;">
                                        <form action="./YYGH_ADD.php" method="post">

                                            <div class="form-group" >
                                                <label for="line1">名称</label>
                                                <input id="l1" type="text" class="form-control" name="name">
                                                <label for="line1">日期</label>
                                                <input id="l1" type="date" class="form-control" name="date">
                                                <label for="line1">数量</label>
