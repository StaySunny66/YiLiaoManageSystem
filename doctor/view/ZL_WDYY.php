        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">我的预约挂号</h1>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">预约信息</h6>
                            </div>
                                        ...
                                        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                            <div class="row"><div class="col-sm-12 col-md-6">
                                                    <div class="dataTables_length" id="dataTable_length">
                                                        ...
                                                        <thead>
                                                        <tr role="row">
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="编号: activate to sort column ascending" style="width: 69px;">患者名称</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="性别: activate to sort column ascending" style="width: 59px;">手机号</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="职位: activate to sort column ascending" style="width: 134px;">预约时间</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <?php
                                                        $data = get_my_yy_user_list($hander['juese']);
                                                        //var_dump($data);
                                                        foreach ($data as $data_line){
                                                            ...
                                                            echo "<tr class=\"odd\">
                                                                                <td class=\"sorting_1\">$L1</td><td>$L2</td><td>$L3</td><td>$L4</td>
                                                                       </tr>";
