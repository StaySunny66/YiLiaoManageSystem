            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body " style="padding-top: 30px;padding-left: 10px">
                                ...
                                <div class="p-3 ">
                                    <?php
                                    echo "手机：".$data['hz_phone'];
                                    ?>
                                </div>
                                <div class="p-3 ">
                                    <?php
                                    echo "家庭住址：".$data['hz_address'];
                                    ?>
                                </div>
                                <div class="p-3 ">
                                    <?php
                                    echo "基础病：".$data['hz_jcb'];
                                    ?>
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">我的预约</h6>
                            </div>
                            <div class="card-body " style="padding-top: 30px;padding-left: 10px">
                                <!-- Circle Buttons (Default) -->
                                ...
                                <div class="p-3 ">
                                    ...
                                    <?php
                                   // var_dump($data);
                                    //echo '预约名称  预约名称  医生姓名   所属科室';
                                    foreach ($data_yy as $data_line){
                                        echo "<tr>
                                            <td>$data_line[0]</td>
                                            <td>$data_line[1]</td>
                                            <td>$data_line[2]</td>
