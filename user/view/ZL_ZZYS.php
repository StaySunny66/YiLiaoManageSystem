        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">选择主治医生</h1>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">医生列表</h6>
                            </div>
                                            ...
                                            <div class="row"><div class="col-sm-12 col-md-6">
                                                    <div class="dataTables_length" id="dataTable_length">
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="职位: activate to sort column ascending" style="width: 134px;">职位</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="部门: activate to sort column ascending" style="width: 148px;">部门</th>
                                                        ...
                                                        foreach ($data as $data_line){
                                                            ...
                                                            echo "<tr class=\"odd\">
                                                                                <td class=\"sorting_1\">$L1</td><td>$L2</td><td>$L3</td><td>$L4</td><td>$L5</td><td><form method='post' action=\"./set_as_doc.php?ys_id=$L1\"> <input  class=\" btn-primary\" type=\"submit\" value=\"选择\"></form></td>
                                                                       </tr>";
